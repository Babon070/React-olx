...
const Header = () => {
  ...
  const takeAvatar = useSelector(state => state.mainReducer)
          ...
          <nav className="header__nav">
            ...
            <Link to="/like" className="header__icon--heart">
              ...
              {likedProducts.length ? (
                <div className="length__like">{likedProducts.length}</div>
              ) : (
                <></>
              )}
            </Link>
            <Link to="shop" className="header__icon--shop">
              ...
              {addToBuy.length ? (
                <div className="length__shop-cards">{addToBuy.length}</div>
              ) : (
                <></>
              )}
            </Link>

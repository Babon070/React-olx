        ...
        <section className='single__product'>
            <Container>
                <div className='product__wrapper'>
                {
                                ...
                                ?   <img className='single__product--img' src={data.images?.at(0)} alt="img"/>
                                :   <img className='single__product--img' src="https://avatars.mds.yandex.net/get-mpic/6780724/img_id5398870021742881284.jpeg/orig" alt="" />
                }
                    ...
                    <div className='product__item--info'>
                        ...
                        <div className='like_heart'>
                            ...
                            {
                                likedProducts.find(p => p?.id === data?.id) ? <AiFillHeart onClick={() => removeFromLikeProducts(data)} style={{color: 'red', cursor: 'pointer'}} /> : <AiOutlineHeart onClick={() => addToLike(data)} style={{cursor: 'pointer'}} />
                            }
                        </div>
